package controls.base
{
   ...
   public class TankInputBox extends TankInputBase
   {
      ...
      public function TankInputBox(_arg_1:String, _arg_2:Boolean = false)
      {
         super();
         this.validatorVisible = _arg_2;
         this.labelBase.text = _arg_1;
      ...
      private function onFocusInInput(_arg_1:FocusEvent) : void
      {
         this.labelBase.visible = false;
      }
      
      private function onFocusOutInput(_arg_1:FocusEvent) : void
      {
         if(value.length == 0)
         {
      ...
      private function onInputChanged(_arg_1:LoginFormEvent) : void
      {
         if(!this.validatorVisible)
         {
            return;
      ...
      private function onCheckTimerComplete(_arg_1:TimerEvent) : void
      {
         if(value.length > 0)
         {
      ...
      public function set validateFunction(_arg_1:Function) : void
      {
         this._validateFunction = _arg_1;
      }
