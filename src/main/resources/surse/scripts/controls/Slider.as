package controls
{
   ...
   public class Slider extends Sprite
   {
      ...
      protected function UnConfigUI(_arg_1:Event) : void
      {
      ...
      protected function dragThumb(_arg_1:MouseEvent) : void
      {
         ...
         _local_2 = this._minValue + this.thumb.x * (this._maxValue - this._minValue) / (width - this._thumb_width);
         this._value = _local_2;
         dispatchEvent(new SliderEvent(_local_2));
      }
