package obfuscation.zoniseg
{
   ...
   public class Vynacoki extends PooledObject implements GraphicEffect
   {
      
      private var container:Scene3DContainer;
      
      private var liqutoz:Batamo;
      ...
      public function Vynacoki(_arg_1:Pool)
      {
         super(_arg_1);
         this.liqutoz = new Batamo();
      }
      ...
      public function init(_arg_1:Vector3, _arg_2:Vector3, _arg_3:Material, _arg_4:Number, _arg_5:Number, _arg_6:Number, _arg_7:Number, _arg_8:int) : void
      {
         ...
         this.qejyvu = _arg_7;
         this.wymot = _arg_8;
         this.liqutoz.init(_arg_4,_local_9,_arg_3,_arg_7);
         this.time = 0;
      }
      ...
      public function play(_arg_1:int, _arg_2:GameCamera) : Boolean
      {
         ...
         Jyj.moruqogi(this.liqutoz,this.vyzepopo,this.direction,_arg_2.position);
         _local_4 = this.time / this.wymot;
         _local_3 = Math.sqrt(_local_4);
         this.liqutoz.scaleX = this.rocob + (this.vosuje - this.rocob) * _local_3;
         this.liqutoz.alpha = 1 - _local_4;
         this.liqutoz.update(_local_3);
         this.time += _arg_1;
         return true;
      }
      ...
      public function qojyf(_arg_1:Scene3DContainer) : void
      {
         ...
         _arg_1.addChild(this.liqutoz);
      }
      
      public function destroy() : void
      {
         this.liqutoz.clear();
         this.container.removeChild(this.liqutoz);
         this.container = null;
         recycle();
      }
