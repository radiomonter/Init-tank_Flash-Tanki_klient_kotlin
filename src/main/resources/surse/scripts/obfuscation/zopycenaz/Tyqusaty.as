package obfuscation.zopycenaz
{
   ...
   public class Tyqusaty implements ICodec
   {
      ...
      public function Tyqusaty(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(String,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<String> = new Vector.<String>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = String(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      public function encode(_arg_1:ProtocolBuffer, _arg_2:Object) : void
      {
         ...
         var _local_4:Vector.<String> = Vector.<String>(_arg_2);
