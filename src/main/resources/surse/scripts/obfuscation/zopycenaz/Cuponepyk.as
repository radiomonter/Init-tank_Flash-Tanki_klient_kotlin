package obfuscation.zopycenaz
{
   ...
   public class Cuponepyk implements ICodec
   {
      ...
      public function Cuponepyk(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(Short,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<int> = new Vector.<int>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = int(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      public function encode(_arg_1:ProtocolBuffer, _arg_2:Object) : void
      {
         ...
         var _local_4:Vector.<int> = Vector.<int>(_arg_2);
