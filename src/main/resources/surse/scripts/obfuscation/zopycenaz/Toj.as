package obfuscation.zopycenaz
{
   ...
   public class Toj implements ICodec
   {
      ...
      public function Toj(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(Float,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<Number> = new Vector.<Number>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = Number(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      public function encode(_arg_1:ProtocolBuffer, _arg_2:Object) : void
      {
         ...
         var _local_4:Vector.<Number> = Vector.<Number>(_arg_2);
