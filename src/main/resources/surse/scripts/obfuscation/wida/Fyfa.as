package obfuscation.wida
{
   ...
   public class Fyfa implements ICodec
   {
      ...
      public function Fyfa(_arg_1:Boolean)
      {
         super();
      ...
      {
         var _local_3:LocalizedFileFormat = null;
         var _local_6:int = 0;
         if(_arg_2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _local_4:Vector.<LocalizedFileFormat> = Vector.<LocalizedFileFormat>(_arg_2);
