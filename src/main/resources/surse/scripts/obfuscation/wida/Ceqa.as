package obfuscation.wida
{
   ...
   public class Ceqa implements ICodec
   {
      ...
      public function Ceqa(_arg_1:Boolean)
      {
         super();
      ...
      {
         var _local_3:ImagePair = null;
         var _local_6:int = 0;
         if(_arg_2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _local_4:Vector.<ImagePair> = Vector.<ImagePair>(_arg_2);
