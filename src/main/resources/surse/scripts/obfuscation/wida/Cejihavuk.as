package obfuscation.wida
{
   ...
   public class Cejihavuk implements ICodec
   {
      ...
      public function init(_arg_1:IProtocol) : void
      {
         ...
         this.diricuvuk = _arg_1.getCodec(new TypeCodecInfo(ByteArray,false));
      }
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         _local_2.value = this.diricuvuk.decode(_arg_1) as ByteArray;
         return _local_2;
      }
