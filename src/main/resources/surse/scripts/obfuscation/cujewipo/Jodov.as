package obfuscation.cujewipo
{
   ...
   public class Jodov extends PooledObject implements Vypalati
   {
      
      private static const libymyr:Number = 48;
      ...
      public function Jodov(_arg_1:Pool)
      {
         super(_arg_1);
         this.tin = new Tin();
      }
      ...
      public function init(_arg_1:Vector3, _arg_2:Vector3, _arg_3:Number, _arg_4:Number, _arg_5:Material, _arg_6:int) : void
      {
         ...
         this.tin.init(libymyr,_arg_3,_arg_4,_arg_5);
      }
