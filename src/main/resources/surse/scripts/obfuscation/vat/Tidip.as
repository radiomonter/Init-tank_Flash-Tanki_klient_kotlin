package obfuscation.vat
{
   ...
   public class Tidip implements Lafo
   {
      ...
      public function Tidip(_arg_1:Wohokoryk)
      {
         super();
         this.output = _arg_1;
      }
      ...
      public function pypuvi(_arg_1:Array) : Boolean
      {
         ...
         blockUserService.unblockUser(_local_2);
         this.output.fikaqu(localeService.getText(TanksLocale.TEXT_CHAT_PANEL_COMMAND_UNBLOCK,_local_2));
         return true;
      }
   }
}
