package obfuscation.bekiz
{
   ...
   public class Sig implements ICodec
   {
      ...
      public function Sig(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(ImageResource,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<ImageResource> = new Vector.<ImageResource>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = ImageResource(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      public function encode(_arg_1:ProtocolBuffer, _arg_2:Object) : void
      {
         ...
         var _local_4:Vector.<ImageResource> = Vector.<ImageResource>(_arg_2);
