package obfuscation.hapog
{
   ...
   public class Lahuwo implements ICodec
   {
      ...
      public function Lahuwo(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(LoginParameters,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<LoginParameters> = new Vector.<LoginParameters>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = LoginParameters(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      {
         var _local_3:LoginParameters = null;
         var _local_6:int = 0;
         if(_arg_2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _local_4:Vector.<LoginParameters> = Vector.<LoginParameters>(_arg_2);
