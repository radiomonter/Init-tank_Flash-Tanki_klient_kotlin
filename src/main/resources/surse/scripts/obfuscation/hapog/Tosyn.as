package obfuscation.hapog
{
   ...
   public class Tosyn implements ICodec
   {
      ...
      public function Tosyn(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new EnumCodecInfo(Gender,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<Gender> = new Vector.<Gender>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = Gender(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      {
         var _local_3:Gender = null;
         var _local_6:int = 0;
         if(_arg_2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _local_4:Vector.<Gender> = Vector.<Gender>(_arg_2);
