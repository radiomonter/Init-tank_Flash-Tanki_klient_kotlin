package obfuscation.qef
{
   ...
   import obfuscation.tupujy.Qasepyhob;
   import obfuscation.tupujy.Qemokumy;
   import obfuscation.tupujy.Zakybevyd;
   import obfuscation.vynoq.Duhuj;
   import obfuscation.vynoq.Luzim;
   import obfuscation.vynoq.Peg;
   
   public class Puge extends Zakybevyd implements Qasepyhob, IWeaponModel, Duhuj, BattleEventListener
   {
      ...
      {
         var _local_2:Qemokumy = getInitParam();
         var _local_3:ConicAreaData = new ConicAreaData(_local_2.coneAngle,BattleUtils.pamo(_local_2.range));
      ...
      public function kyqyqemy(_arg_1:ClientObject) : Weapon
      {
         ...
         var _local_4:ConicAreaData = ConicAreaData(_local_2.turret.getParams(ConicAreaData));
         var _local_5:Hebesed = new Hebesed(_local_4.fediri(),_local_4.riv(),Fodehuqym.bigob,Fodehuqym.fotuwym,_local_3,battleService.moq());
         var _local_6:Lerih = new Lerih();
         var _local_7:Hiharec = wyj(_local_2.turret);
         var _local_8:Number = _local_7.waqatyw();
         var _local_9:Number = _local_7.gefifoho();
         var _local_10:Number = _local_7.bezab();
         var _local_11:Weapon = new Luzim(_local_8,_local_9,_local_10,_local_7.huzyz(),_local_5,_local_6,this,this.fireru(_arg_1));
      ...
      private function fireru(_arg_1:ClientObject) : Peg
      {
         ...
         var _local_4:Tycuva = WeaponsManager.getFlamethrowerSFX(_arg_1);
         return _local_4.towymory(_local_3.fediri(),_local_3.riv(),_arg_1);
      }
