package obfuscation.syfy
{
   ...
   public class Katito implements ICodec
   {
      ...
      public function Katito(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(ResourceImageFrameParams,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<ResourceImageFrameParams> = new Vector.<ResourceImageFrameParams>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = ResourceImageFrameParams(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      {
         var _local_3:ResourceImageFrameParams = null;
         var _local_6:int = 0;
         if(_arg_2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _local_4:Vector.<ResourceImageFrameParams> = Vector.<ResourceImageFrameParams>(_arg_2);
