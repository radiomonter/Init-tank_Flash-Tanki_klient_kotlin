package obfuscation.tyf
{
   ...
   public class Dysihuma extends BlackRoundRect
   {
      ...
      private static const bilitohez:Class = Nynudazyt;
      ...
      private function init() : void
      {
         ...
         _local_7.size = _local_5;
         _local_7.text = localeService.getText(TanksLocale.TEXT_REARM_APPLY);
         _local_7.y = _local_1;
         addChild(_local_7);
         width = _local_7.textWidth;
         _local_1 += _local_7.height;
