package obfuscation.kuliz
{
   ...
   public class Fafoseda implements ICodec
   {
      ...
      public function Fafoseda(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(Timestamp,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<Timestamp> = new Vector.<Timestamp>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = Timestamp(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      {
         var _local_3:Timestamp = null;
         var _local_6:int = 0;
         if(_arg_2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _local_4:Vector.<Timestamp> = Vector.<Timestamp>(_arg_2);
