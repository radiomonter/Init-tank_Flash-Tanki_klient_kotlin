package obfuscation.vaqu
{
   ...
   public class Werowabe implements ICodec
   {
      ...
      public function Werowabe(_arg_1:Boolean)
      {
         super();
      ...
      {
         this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(IGameObject,false));
         if(this.syrerehyh)
         {
      ...
      public function decode(_arg_1:ProtocolBuffer) : Object
      {
         ...
         var _local_3:Vector.<IGameObject> = new Vector.<IGameObject>(_local_2,true);
         while(_local_4 < _local_2)
         {
            _local_3[_local_4] = IGameObject(this.elementCodec.decode(_arg_1));
            _local_4++;
         }
         return _local_3;
      }
      ...
      public function encode(_arg_1:ProtocolBuffer, _arg_2:Object) : void
      {
         ...
         var _local_4:Vector.<IGameObject> = Vector.<IGameObject>(_arg_2);
