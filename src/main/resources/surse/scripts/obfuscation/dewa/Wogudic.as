package obfuscation.dewa
{
   ...
   public class Wogudic
   {
      ...
      private var dyrulypuj:Long = Long.getLong(1744513692,181388452);
      ...
      private var sicypi:ICodec;
      
      private var bycyp:ICodec;
      
      private var hotif:Long = Long.getLong(430590662,-88054305);
      
      private var risur:ICodec;
      
      private var pabypus:Long = Long.getLong(625603135,-1078364647);
      ...
      public function Wogudic(_arg_1:IModel)
      {
         super();
         this.model = _arg_1;
