package org.robotlegs.mvcs
{
   ...
   public class Context extends ContextBase implements IContext
   {
      ...
      public function Context(_arg_1:DisplayObjectContainer = null, _arg_2:Boolean = true)
      {
         super();
         this._contextView = _arg_1;
         this._autoStartup = _arg_2;
      ...
      protected function set injector(_arg_1:IInjector) : void
      {
      ...
      protected function set reflector(_arg_1:IReflector) : void
      {
      ...
      protected function set commandMap(_arg_1:ICommandMap) : void
      {
         this._commandMap = _arg_1;
      }
      ...
      protected function set mediatorMap(_arg_1:IMediatorMap) : void
      {
         this._mediatorMap = _arg_1;
      }
      ...
      protected function set viewMap(_arg_1:IViewMap) : void
      {
         this._viewMap = _arg_1;
      }
      ...
      {
         var _local_1:IInjector = new SwiftSuspendersInjector();
         _local_1.applicationDomain = this.getApplicationDomainFromContextView();
         return _local_1;
      }
