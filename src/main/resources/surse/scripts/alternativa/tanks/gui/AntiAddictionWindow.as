package alternativa.tanks.gui
{
   ...
   public class AntiAddictionWindow extends Sprite
   {
      ...
      public function AntiAddictionWindow(_arg_1:int)
      {
         super();
         ...
         this.window.headerLang = _local_2.getText(TextConst.GUI_LANG);
         this.watches = _arg_1 >= 5 * 60 ? new Watches5Hours() : new Watches3Hours();
         this.watches.x = 12;
         this.watches.y = 34;
      ...
      private function restoreInput(_arg_1:FocusEvent) : void
      {
      ...
      private function validateAddictionID(_arg_1:FocusEvent) : void
      {
         ...
         {
            _local_2 = this.idCardInput.value.length;
            this.idCardInput.validValue = _local_2 == 18;
         }
      }
      ...
      private function onCancelClicked(_arg_1:Event) : void
      {
         dispatchEvent(new Event(Event.CANCEL));
      }
      
      private function onOkClicked(_arg_1:Event) : void
      {
