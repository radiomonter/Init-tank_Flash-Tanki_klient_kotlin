package alternativa.tanks.gui.friends.battleinvite
{
   ...
   public class BattleInviteNotification extends Notification
   {
      ...
      public function BattleInviteNotification(_arg_1:String, _arg_2:String, _arg_3:String, _arg_4:String, _arg_5:Boolean, _arg_6:String, _arg_7:Boolean)
      {
         this._battleId = _arg_3;
         this._battleUrl = _arg_4;
         this._isRemoteBattleUrl = _arg_5;
         this._noSuppliesBattle = _arg_7;
         this._mapAndServerNumberString = _arg_6;
         super(_arg_1,_arg_2);
      }
      
      private static function isShowAlertAboutInaccessibleInStandalone() : Boolean
      {
         var _local_1:* = storageService.getStorage().data[SHOW_ALERT_ABOUT_INACCESSIBLE_IN_STANDALONE];
         return _local_1 != undefined;
      }
      ...
      override protected function closeNotification() : void
      {
         ...
         {
            battleAlertService.showAlert(localeService.getText(TextConst.STRING_YOUR_ARE_PLAING_SAFP_ALERT),Vector.<String>([localeService.getText(AlertAnswer.OK)]));
            markAsShowAlertAboutInaccessibleInStandalone();
         }
         hide();
      }
      
      override public function show(_arg_1:Signal) : void
      {
         super.show(_arg_1);
      ...
      override protected function resize() : void
      {
         ...
         _local_2 = this._baseMessageLabel.getLineMetrics(0);
         if(this._noSuppliesBattle)
         {
            this._noSuppliesIcon.x = GAP + 12;
            this._noSuppliesIcon.y = this._baseMessageLabel.y + _local_2.height + 3;
            this._mapAndServerNumberMessageLabel.x = this._noSuppliesIcon.x + this._noSuppliesIcon.width + 2;
         }
         this._mapAndServerNumberMessageLabel.y = this._baseMessageLabel.y + _local_2.height;
         _innerHeight = this._baseMessageLabel.y + this._baseMessageLabel.height - 3;
         var _local_3:int = this._baseMessageLabel.x + this._baseMessageLabel.width + GAP * 2;
         if(_local_3 > _width)
         {
            _width = _local_3;
         }
         ...
         {
            _local_1 = _innerHeight + 16;
            this._acceptButton.x = GAP;
            this._acceptButton.y = _local_1;
            this._rejectButton.x = _width - this._rejectButton.width - GAP;
            this._rejectButton.y = _local_1;
