package alternativa.tanks.gui.battle
{
   ...
   public class BattleFinishNotification extends Notification
   {
      ...
      override protected function resize() : void
      {
         ...
         var _local_1:TextLineMetrics = this._messageLabel.getLineMetrics(this._messageLabel.numLines - 1);
         this._diamond.x = int(this._messageLabel.x + _local_1.width + 5);
         ...
         var _local_2:int = this._messageLabel.x + this._messageLabel.width + GAP * 2;
         if(_local_2 > _width)
         {
            _width = _local_2;
         }
      ...
      protected function getRewardText(_arg_1:int, _arg_2:int) : String
      {
         var _local_3:String = String(_arg_1);
         if(_arg_2 > 0)
         {
            _local_3 = "<font color=\"#f3c800\">" + String(_arg_1 + _arg_2) + "</font>";
         }
         return _local_3;
      }
   }
