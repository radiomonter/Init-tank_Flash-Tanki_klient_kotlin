package alternativa.tanks.gui.error
{
   ...
   public class ErrorNotification extends Notification
   {
      ...
      private function onReenterClick(_arg_1:MouseEvent) : void
      {
      ...
      override protected function resize() : void
      {
         ...
         var _local_1:int = this.messageLabel.x + this.messageLabel.width + GAP * 2;
         if(_local_1 > _width)
         {
            _width = _local_1;
         }
