package alternativa.tanks.gui.friends
{
   ...
   public class FriendsWindow extends DialogWindow
   {
      ...
      {
         this._window = new TankWindowWithHeader(Headers.getHeaderById("FRIENDS"));
      ...
      private function onClickRejectAllIncoming(_arg_1:MouseEvent) : void
      {
         var _local_2:String = localeService.getText(TextConst.STRING_FRIENDS_DECLINE_ALL_REQUESTS_ALERT);
      ...
      private function onConfirmRejectAllIncoming(_arg_1:AlertServiceEvent) : void
      {
         ...
         else if(_arg_1.typeButton == localeService.getText(TextConst.ALERT_ANSWER_NO) && dialogWindowsDispatcherService.isOpen())
         {
            blurService.blur();
         }
      ...
      private function onTextChangeSearchInList(_arg_1:LoginFormEvent) : void
      {
      ...
      private function onFocusInSearchInList(_arg_1:FocusEvent) : void
      {
         this._searchInListLabel.visible = false;
      }
      
      private function onFocusOutSearchInList(_arg_1:FocusEvent) : void
      {
         this.updateVisibleSearchInListLabel();
      }
      ...
      private function onBattleLinkClick(_arg_1:BattleLinkActivatorServiceEvent) : void
      {
         this.hide();
      }
      ...
      private function resize() : void
      {
         ...
         var _local_1:int = this._windowInner.x + 4;
         var _local_2:int = this._windowInner.y + 4;
         var _local_3:int = this._windowInner.width - 4 * 2 + 2;
         var _local_4:int = this._windowInner.height - 4 * 2;
         this._acceptedList.resize(_local_3,_local_4);
         this._acceptedList.x = _local_1;
         this._acceptedList.y = _local_2;
         this._outgoingList.resize(_local_3,_local_4);
         this._outgoingList.x = _local_1;
         this._outgoingList.y = _local_2;
         this._incomingList.resize(_local_3,_local_4);
         this._incomingList.x = _local_1;
         this._incomingList.y = _local_2;
      ...
      private function onChangeState(_arg_1:MouseEvent) : void
      {
         this.show(FriendStateButton(_arg_1.currentTarget).type);
      }
      ...
      public function show(_arg_1:FriendsWindowState) : void
      {
      ...
      private function onUpdateIncomingCounter(_arg_1:NewFriendEvent) : void
      {
         this.updateIncomingCounter();
      }
      
      private function onUpdateAcceptedCounter(_arg_1:NewFriendEvent) : void
      {
         this.updateAcceptedCounter();
      }
      ...
      private function updateState(_arg_1:FriendsWindowState) : void
      {
      ...
      public function set currentState(_arg_1:FriendsWindowState) : void
      {
