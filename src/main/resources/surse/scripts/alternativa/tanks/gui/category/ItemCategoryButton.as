package alternativa.tanks.gui.category
{
   ...
   public class ItemCategoryButton extends FixedHeightButton
   {
      ...
      public function ItemCategoryButton(_arg_1:ItemViewCategoryEnum)
      {
         ...
         var _local_3:ILocaleService = ILocaleService(OSGi.getInstance().getService(ILocaleService));
         switch(_arg_1)
         {
            case ItemViewCategoryEnum.SPECIAL:
               this._icon = new specialIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_SPECIAL);
               break;
            case ItemViewCategoryEnum.WEAPON:
               this._icon = new weaponIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_TURRETS);
               break;
            case ItemViewCategoryEnum.ARMOR:
               this._icon = new armorIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_HULLS);
               break;
            case ItemViewCategoryEnum.PAINT:
               this._icon = new colorIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_PAINTS);
               break;
            case ItemViewCategoryEnum.KIT:
               this._icon = new kitIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_KITS);
               break;
            case ItemViewCategoryEnum.INVENTORY:
               this._icon = new inventoryIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_SUPPLIES);
               break;
            case ItemViewCategoryEnum.RESISTANCE:
               _local_2 = _local_3.getText(TanksLocale.TEXT_GARAGE_CATEGORY_BUTTON_RESISTANCE_MODULES);
               this._icon = new resistanceIconClass();
               break;
            case ItemViewCategoryEnum.GIVEN_PRESENTS:
               this._icon = new givenPresentsIconClass();
               _local_2 = _local_3.getText(TextConst.STRING_GARAGE_CATEGORY_BUTTON_PRESENTS);
         }
         _innerLayer.addChild(this._icon);
         _label.text = _local_2;
      ...
      override public function set width(_arg_1:Number) : void
      {
         ...
         this._newItemIndicator.x = _arg_1 - (this._newItemIndicator.width >> 1) - 4;
         this._discountIndicator.x = _arg_1 - (this._discountIndicator.width >> 1) - 4;
