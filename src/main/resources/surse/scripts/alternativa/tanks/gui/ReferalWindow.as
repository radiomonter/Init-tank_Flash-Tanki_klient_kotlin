package alternativa.tanks.gui
{
   ...
   public class ReferalWindow extends DialogWindow
   {
      ...
      public function ReferalWindow(hash:String, bannerCodeString:String, url:String, messageTemplate:String)
      {
         ...
         this.window = new TankWindowWithHeader(Headers.getHeaderById("INVITE_A_FRIEND"));
         ...
         _local_6 = this.banner as Sprite;
         with(_local_6)
         {
      ...
      public function addReferals(_arg_1:Array) : void
      {
         var _local_2:int = 0;
         var _local_3:int = 0;
         this.countLabel.text = _arg_1.length.toString();
         while(_local_3 < _arg_1.length)
         {
            _local_2 += _arg_1[_local_3].income;
            _local_3++;
         }
         this.crystalLabel.text = _local_2.toString();
         this.statButton.label = this.localeService.getText(TextConst.REFERAL_WINDOW_BUTTON_STATISTICS_TEXT) + " " + _local_2.toString();
         this.referalList.addReferrals(_arg_1);
      ...
      private function onClickCloseButton(_arg_1:MouseEvent = null) : void
      {
         this.closeWindow();
      }
      ...
      private function onUsernameChange(_arg_1:Event) : void
      {
         if(Boolean(this.nameInput.textField.text.length))
         {
            this.mailText.tf.text = this.messageTemplate.replace("%1",this.nameInput.textField.text);
         }
      }
      
      private function addbanner(_arg_1:Event) : void
      {
         this.bannerLoadEffect.gotoAndStop(CallsignIconStates.CALLSIGN_ICON_STATE_PROGRESS);
      ...
      private function onStatClick(_arg_1:MouseEvent) : void
      {
      ...
      private function onLinkClick(_arg_1:MouseEvent) : void
      {
      ...
      private function onBannerClick(_arg_1:MouseEvent) : void
      {
         this.getLinkButton.enable = true;
      ...
      private function onMailClick(_arg_1:MouseEvent) : void
      {
         this.getLinkButton.enable = true;
         this.getBannerButton.enable = true;
      ...
      private function copyLink(_arg_1:MouseEvent) : void
      {
         System.setClipboard(this.linkURL.textField.text);
      }
      
      private function copyBanner(_arg_1:MouseEvent) : void
      {
         System.setClipboard(this.bannerCode.tf.text);
      }
      
      private function sendLetter(_arg_1:MouseEvent) : void
      {
