package alternativa.tanks.gui.friends
{
   ...
   public class AddRequestView extends Sprite
   {
      ...
      private function onClickAddRequestButton(_arg_1:MouseEvent) : void
      {
         this.addRequest();
      }
      ...
      private function onUidExist(_arg_1:FriendActionServiceUidEvent) : void
      {
         this._searchFriendTextInput.validValue = true;
      ...
      private function onUidNotExist(_arg_1:FriendActionServiceUidEvent) : void
      {
         this._searchFriendUid = null;
      ...
      private function onAlreadyInAcceptedFriends(_arg_1:FriendActionServiceUidEvent) : void
      {
         var _local_2:String = localeService.getText(TextConst.STRING_FRIENDS_PLAYER_ALREADY_IN_LIST_ALERT).replace("%USERNAME%",_arg_1.uid);
         alertService.showAlert(_local_2,Vector.<String>([localeService.getText(TextConst.ALERT_ANSWER_OK)]));
         alertService.addEventListener(AlertServiceEvent.ALERT_BUTTON_PRESSED,this.onAlreadyInAcceptedFriendsAlertClick);
      }
      
      private function onAlreadyInAcceptedFriendsAlertClick(_arg_1:AlertServiceEvent) : void
      {
      ...
      private function onAlreadyInOutgoingFriends(_arg_1:FriendActionServiceUidEvent) : void
      {
         var _local_2:String = localeService.getText(TextConst.STRING_FRIENDS_REQUEST_EXIST_ALERT).replace("%USERNAME%",_arg_1.uid);
         alertService.showAlert(_local_2,Vector.<String>([localeService.getText(TextConst.ALERT_ANSWER_OK)]));
         alertService.addEventListener(AlertServiceEvent.ALERT_BUTTON_PRESSED,this.onAlreadyInOutgoingFriendsAlertClick);
      }
      
      private function onAlreadyInOutgoingFriendsAlertClick(_arg_1:AlertServiceEvent) : void
      {
      ...
      private function onAlreadyInIncomingFriends(_arg_1:FriendActionServiceUidEvent) : void
      {
         this._searchUserId = _arg_1.userId;
         var _local_2:String = localeService.getText(TextConst.STRING_FRIENDS_ALREADY_HAVE_INCOMING).replace("%USERNAME%",_arg_1.uid);
         alertService.showAlert(_local_2,Vector.<String>([localeService.getText(TextConst.STRING_FRIENDS_YES),localeService.getText(TextConst.STRING_FRIENDS_CANCEL_BUTTON_TEXT)]));
         alertService.addEventListener(AlertServiceEvent.ALERT_BUTTON_PRESSED,this.onAlreadyInIncomingFriendsAlertConfirm);
      }
      
      private function onAlreadyInIncomingFriendsAlertConfirm(_arg_1:AlertServiceEvent) : void
      {
