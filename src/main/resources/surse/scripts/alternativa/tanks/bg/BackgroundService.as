package alternativa.tanks.bg
{
   ...
   public class BackgroundService implements IBackgroundService
   {
      ...
      public function BackgroundService()
      {
         ...
         var _local_1:IDisplay = this.osgi.getService(IDisplay) as IDisplay;
         this.stage = _local_1.stage;
         this.bgLayer = _local_1.backgroundLayer;
         this.bg = new Shape();
      }
      ...
      public function drawBg(_arg_1:Rectangle = null) : void
      {
         this.bgCropRect = _arg_1;
         this.redrawBg();
      }
      
      private function redrawBg(_arg_1:Event = null) : void
      {
