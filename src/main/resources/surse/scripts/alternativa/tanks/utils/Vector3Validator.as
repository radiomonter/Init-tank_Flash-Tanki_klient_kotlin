package alternativa.tanks.utils
{
   ...
   public class Vector3Validator
   {
      ...
      public function Vector3Validator(_arg_1:Vector3)
      {
         super();
         this.vector = _arg_1;
         this.x = new EncryptedNumberImpl(_arg_1.x);
         this.y = new EncryptedNumberImpl(_arg_1.y);
         this.z = new EncryptedNumberImpl(_arg_1.z);
      }
