package alternativa.tanks.utils
{
   ...
   public class Matrix4Validator
   {
      ...
      public function Matrix4Validator(_arg_1:Matrix4)
      {
         super();
         this.m = _arg_1;
         this.a = new EncryptedNumberImpl(_arg_1.m00);
         this.b = new EncryptedNumberImpl(_arg_1.m01);
         this.c = new EncryptedNumberImpl(_arg_1.m02);
         this.d = new EncryptedNumberImpl(_arg_1.m03);
         this.e = new EncryptedNumberImpl(_arg_1.m10);
         this.f = new EncryptedNumberImpl(_arg_1.m11);
         this.g = new EncryptedNumberImpl(_arg_1.m12);
         this.h = new EncryptedNumberImpl(_arg_1.m13);
         this.i = new EncryptedNumberImpl(_arg_1.m20);
         this.j = new EncryptedNumberImpl(_arg_1.m21);
         this.k = new EncryptedNumberImpl(_arg_1.m22);
         this.l = new EncryptedNumberImpl(_arg_1.m23);
      }
