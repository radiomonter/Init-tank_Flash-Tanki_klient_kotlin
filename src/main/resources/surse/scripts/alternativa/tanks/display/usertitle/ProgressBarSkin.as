package alternativa.tanks.display.usertitle
{
   ...
   public class ProgressBarSkin
   {
      ...
      public function ProgressBarSkin(_arg_1:uint, _arg_2:uint, _arg_3:BitmapData, _arg_4:BitmapData, _arg_5:BitmapData, _arg_6:BitmapData, _arg_7:BitmapData, _arg_8:BitmapData, _arg_9:BitmapData)
      {
         super();
         this.color = _arg_1;
         this.bgColor = _arg_2;
         this.leftTipFg = _arg_3;
         this.leftTipBg = _arg_4;
         this.rightTipFg = _arg_5;
         this.rightTipBg = _arg_6;
         this.shadow = _arg_7;
         this.shadowLeftTip = _arg_8;
         this.shadowRightTip = _arg_9;
      }
      
      public static function getHealthBarSkin(_arg_1:BattleTeam) : ProgressBarSkin
      {
         switch(_arg_1)
         {
