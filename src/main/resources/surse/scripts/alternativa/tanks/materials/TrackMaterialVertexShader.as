package alternativa.tanks.materials
{
   ...
   public class TrackMaterialVertexShader extends VertexShader
   {
      ...
      public function TrackMaterialVertexShader(_arg_1:Boolean, _arg_2:Boolean, _arg_3:Boolean, _arg_4:Boolean, _arg_5:Boolean, _arg_6:Boolean, _arg_7:Boolean, _arg_8:Boolean, _arg_9:Boolean, _arg_10:Boolean)
      {
         super();
         mov(vt0,vc[4]);
         if(_arg_1)
         ...
         else if(_arg_5 || _arg_6 || _arg_9 || _arg_10)
         {
            mov(vt1,vc[4]);
         }
         if(_arg_5)
