package alternativa.tanks.materials
{
   ...
   public class AnimatedPaintFragmentShader extends FragmentShader
   {
      ...
      public function AnimatedPaintFragmentShader(_arg_1:Boolean, _arg_2:Boolean, _arg_3:Boolean, _arg_4:Boolean, _arg_5:Boolean, _arg_6:Boolean, _arg_7:Boolean, _arg_8:Boolean, _arg_9:Boolean, _arg_10:Boolean, _arg_11:Boolean, _arg_12:Boolean, _arg_13:Boolean, _arg_14:Boolean, _arg_15:Boolean, _arg_16:Boolean, _arg_17:Boolean, _arg_18:Boolean)
      {
         var _local_19:int = 0;
         super();
         ...
         tex(ft0,ft4,fs4.dim(SamplerDim.D2).repeat(_local_20).filter(_local_21).mipmap(_local_22).type(_local_23));
