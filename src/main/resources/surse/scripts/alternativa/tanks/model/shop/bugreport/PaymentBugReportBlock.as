package alternativa.tanks.model.shop.bugreport
{
   ...
   public class PaymentBugReportBlock extends Sprite
   {
      ...
      public function PaymentBugReportBlock()
      {
         ...
         this.errorButton.addEventListener(MouseEvent.CLICK,this.qopud);
      ...
      private function qopud(_arg_1:MouseEvent) : void
      {
         navigateToURL(new URLRequest("https://discord.gg/flashtanki"),"_blank");
      }
