package alternativa.tanks.model.shop.items.crystallitem
{
   ...
   public class CrystalPackageItem extends ShopItemBase
   {
      ...
      public function CrystalPackageItem(_arg_1:String, _arg_2:Object)
      {
         this.additionalData = _arg_2;
         super(_arg_1,ShopItemSkins.GREEN);
      }
      ...
      override public function set gridPosition(_arg_1:int) : void
      {
         ...
         var _local_2:BitmapData = CrystalPackageItemIcons.crystalsPackages[gridPosition];
         if(!_local_2 && _arg_1 != 0)
         {
            _local_2 = CrystalPackageItemIcons.crystalsPackages[CrystalPackageItemIcons.crystalsPackages.length - 1];
         }
         if(Boolean(_local_2))
         {
            this.crystalsIcon = new Bitmap(_local_2);
