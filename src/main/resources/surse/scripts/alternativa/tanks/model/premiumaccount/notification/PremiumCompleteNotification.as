package alternativa.tanks.model.premiumaccount.notification
{
   ...
   public class PremiumCompleteNotification extends Notification
   {
      ...
      public function PremiumCompleteNotification(_arg_1:String)
      {
         super(null,_arg_1,false);
      }
      ...
      private function onAcceptClick(_arg_1:MouseEvent = null) : void
      {
         hide();
      ...
      override protected function resize() : void
      {
         ...
         var _local_1:int = this._baseMessageLabel.x + this._baseMessageLabel.width + GAP * 2;
         if(_local_1 > _width)
         {
            _width = _local_1;
         }
         var _local_2:int = _innerHeight + 16;
         this._acceptButton.x = GAP;
         this._acceptButton.y = _local_2;
         this._rejectButton.x = _width - this._rejectButton.width - GAP;
         this._rejectButton.y = _local_2;
