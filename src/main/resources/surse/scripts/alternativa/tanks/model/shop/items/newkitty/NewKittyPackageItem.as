package alternativa.tanks.model.shop.items.newkitty
{
   ...
   public class NewKittyPackageItem extends ShopItemBase
   {
      ...
      private var NewKittyLabel:LabelBase;
      ...
      public function NewKittyPackageItem(_arg_1:String, _arg_2:Object)
      {
      ...
      private function initCrystalsAndPrice() : void
      {
         ...
         this.NewKittyLabel = new LabelBase();
         this.NewKittyLabel.text = this.localeService.language == "ru" ? "+16 дней" : "+16 days";
         this.NewKittyLabel.color = this.WHITE_TEXT_LABEL_COLOR;
         this.NewKittyLabel.autoSize = TextFieldAutoSize.LEFT;
         this.NewKittyLabel.size = 26;
         this.NewKittyLabel.bold = true;
         this.NewKittyLabel.mouseEnabled = false;
         addChild(this.NewKittyLabel);
         addChild(this.priceLabel);
      }
      
      private function initContainerIcon() : void
      {
         this.icon = new Bitmap(NewKittyPackageDefItemIcons.NewKittyDefIcon);
         addChild(this.icon);
      }
      ...
      private function onMouseOver(event:MouseEvent) : void
      {
         ...
         this.icon = new Bitmap(NewKittyPackageLigItemIcons.NewKittyLigIcon);
         addChild(this.icon);
         addChild(this.NewKittyLabel);
         addChild(this.priceLabel);
         this.render();
      ...
      private function render() : void
      {
         ...
         this.NewKittyLabel.x = LEFT_PADDING + 375;
         this.NewKittyLabel.y = this.icon.y + this.icon.height - this.priceLabel.height - 17;
