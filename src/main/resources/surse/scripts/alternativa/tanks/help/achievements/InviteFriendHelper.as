package alternativa.tanks.help.achievements
{
   ...
   public class InviteFriendHelper extends BubbleHelper
   {
      ...
      public function InviteFriendHelper()
      {
         ...
         text = _local_1.getText(TanksLocale.TEXT_HELP_PANEL_ACHIEVEMENTS_INVITE_FRIEND_TEXT);
         arrowLehgth = int(_local_1.getText(TanksLocale.TEXT_HELP_PANEL_ACHIEVEMENTS_INVITE_FRIEND_ARROW_LENGTH));
