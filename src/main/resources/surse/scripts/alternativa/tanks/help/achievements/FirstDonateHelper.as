package alternativa.tanks.help.achievements
{
   ...
   public class FirstDonateHelper extends BubbleHelper
   {
      ...
      public function FirstDonateHelper()
      {
         ...
         text = _local_1.getText(TanksLocale.TEXT_HELP_PANEL_ACHIEVEMENTS_FIRST_DONATE_TEXT);
         arrowLehgth = int(_local_1.getText(TanksLocale.TEXT_HELP_PANEL_ACHIEVEMENTS_FIRST_DONATE_ARROW_LENGTH));
