package alternativa.tanks.view
{
   ...
   public class RegistrationFormMediator extends Mediator
   {
      ...
      private function dispatchStartExternalRegistration(_arg_1:StartExternalEntranceEvent) : void
      {
         dispatch(_arg_1);
      }
      
      private function onClickRegistrationButton(_arg_1:RegistrationFormEvent) : void
      {
      ...
      private function onGoToFirstBattle(_arg_1:MouseEvent) : void
      {
         dispatch(new PassToFirstBattle());
      }
      
      private function onBackgroundLoaded(_arg_1:RegistrationBackgroundLoadedEvent) : void
      {
         this.view.setBackground(_arg_1.backgroundImage);
      }
   }
}
