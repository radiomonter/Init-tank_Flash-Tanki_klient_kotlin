package alternativa.tanks.view.registration
{
   ...
   public class CaptchaSection extends Sprite
   {
      ...
      {
         this.label.width = _arg_1 - this.label.x;
         this.captchaContainer.width = _arg_1;
         this.captchaAnswer.width = _arg_1;
      ...
      {
         this.captchaAnswer.enable = _arg_1;
         this.refreshButton.doubleClickEnabled = _arg_1;
         this.refreshButton.mouseEnabled = _arg_1;
      }
   }
}
