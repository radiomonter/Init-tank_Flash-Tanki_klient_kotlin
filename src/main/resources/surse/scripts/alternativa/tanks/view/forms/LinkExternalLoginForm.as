package alternativa.tanks.view.forms
{
   ...
   public class LinkExternalLoginForm extends Sprite
   {
      ...
      private function onPlayClicked(_arg_1:MouseEvent = null) : void
      {
      ...
      private function onKeyDownPasswordInput(_arg_1:KeyboardEvent) : void
      {
         if(_arg_1.keyCode == Keyboard.ENTER && this._playButton.enable)
         {
            this.onPlayClicked();
         }
      }
      ...
      private function onCaptchaRefresh(_arg_1:MouseEvent = null) : void
      {
      ...
      private function showErrorWindow(_arg_1:int) : void
      {
         ...
         display.contentUILayer.addChild(_local_2);
      }
      ...
      public function set socialNetworkId(_arg_1:String) : void
      {
      ...
      private function makeNameFromId(_arg_1:String) : String
      {
