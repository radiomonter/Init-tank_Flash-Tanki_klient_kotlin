package alternativa.tanks.view.bubbles
{
   ...
   public class Bubble extends Sprite
   {
      ...
      public function Bubble(_arg_1:Point)
      {
         super();
         this._size = new Point();
         this.relativePosition = _arg_1;
         this.bmp = new Bitmap();
         addChild(this.bmp);
      ...
      protected function draw() : void
      {
         ...
         var _local_1:Number = this._arrowLehgth / arrowWidth;
         if(Boolean(this._arrowAlign & HelperAlign.TOP_MASK))
         {
            ...
            this.outlineArrowTarget.y = -_local_1 * (arrowWidth + lineThickness * 2);
         }
         ...
         else
         {
            ...
            this.outlineArrowTarget.y = this._size.y + _local_1 * (arrowWidth + lineThickness * 2);
         }
         if(Boolean(this._arrowAlign & HelperAlign.LEFT_MASK))
         {
            ...
            else
            {
               ...
               this.arrowP1.x = 0;
               this.arrowP2.x = 0;
               this.outlineArrowTarget.x = -_local_1 * (arrowWidth + lineThickness * 2);
         ...
         else
         {
            ...
            else
            {
               ...
               this.outlineArrowTarget.x = this._size.x + _local_1 * (arrowWidth + lineThickness * 2);
         ...
         this.bmp.bitmapData.draw(this.backContainer,_local_3,new ColorTransform(),BlendMode.NORMAL,null,true);
         stage.quality = _local_2;
