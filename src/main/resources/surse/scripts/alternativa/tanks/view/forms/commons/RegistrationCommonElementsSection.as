package alternativa.tanks.view.forms.commons
{
   ...
   public class RegistrationCommonElementsSection extends Sprite
   {
      ...
      private static function isPasswordForbidden(_arg_1:String) : Boolean
      {
         return _arg_1.length < passwordParamsService.minPasswordLength || passwordParamsService.forbiddenPasswords.indexOf(_arg_1.toLowerCase()) != -1;
      }
      ...
      {
         this._pass1.textField.text = _arg_1;
         if(_arg_1.length != 0)
         {
      ...
      public function set verificationPassword(_arg_1:String) : void
      {
         this._pass2.textField.text = _arg_1;
         if(_arg_1.length != 0)
         {
            this.onPasswordChanged();
         }
      ...
      public function set emailText(_arg_1:String) : void
      {
         this._emailInput.value = _arg_1;
         if(_arg_1.length != 0)
         {
            this.onEmailChanged();
         }
      ...
      public function set idNumber(_arg_1:String) : void
      {
         ...
         {
            this._antiAddictionSection.idNumber.textField.text = _arg_1;
         }
      }
      ...
      public function set realName(_arg_1:String) : void
      {
         if(this._antiAddictionSection != null)
         {
            this._antiAddictionSection.realName.textField.text = _arg_1;
         }
      }
      ...
      public function set captcha(_arg_1:Bitmap) : void
      {
         this._captchaSection.captcha = _arg_1;
      }
      
      private function onContinueButtonClick(_arg_1:MouseEvent = null) : void
      {
         this._continueButton.enable = false;
         this.removeEvents();
      ...
      private function onRefreshCaptcha(_arg_1:MouseEvent) : void
      {
      ...
      public function showCommonElements(_arg_1:Boolean, _arg_2:Boolean, _arg_3:Boolean = false) : void
      {
         this._registrationThroughEmail = _arg_3;
         this.updatePositionAndVisibleElements();
         this.updateTabIndex();
         var _local_4:int = (!_arg_3 ? this._pass2.y + this._pass2.height : this._emailInput.y + this._emailInput.height) + this._margin;
         if(!_arg_3)
         {
         ...
         if(_arg_2)
         {
            ...
            this._antiAddictionSection.y = _local_4;
            this._antiAddictionSection.x = 15;
            _local_4 += this._antiAddictionSection.height + this._margin;
         }
         if(_arg_1)
         {
            this._captchaSection.visible = true;
            this._captchaSection.x = this._inputsLeftMargin;
            this._captchaSection.y = _local_4;
            _local_4 += this._captchaSection.height + this._margin;
         }
         this._checkRemember.y = _local_4;
         this._continueButton.y = this._checkRemember.y;
         _local_4 += this._checkRemember.height;
         _local_4 += this._margin - 5;
         this._rulesButton.y = _local_4;
         _local_4 += this._rulesButton.height;
         this._windowHeight = _local_4;
         this.setEvents();
      }
      ...
      private function onEmailChanged(_arg_1:LoginFormEvent = null) : void
      {
      ...
      private function onPasswordChanged(_arg_1:LoginFormEvent = null) : void
      {
      ...
      private function togglePlayButton() : void
      {
         ...
         if(this._antiAddictionEnabled)
         {
            _local_1 = this._antiAddictionSection.isIdValid() && this._antiAddictionSection.isRealNameValid();
            this._continueButton.enable = this._continueButton.enable && _local_1;
         }
      }
      ...
      private function onEmailCheckTimerComplete(_arg_1:TimerEvent) : void
      {
      ...
      private function onAntiAddictionUpdated(_arg_1:AntiAddictionInfoUpdatedEvent) : void
      {
         this.togglePlayButton();
      }
