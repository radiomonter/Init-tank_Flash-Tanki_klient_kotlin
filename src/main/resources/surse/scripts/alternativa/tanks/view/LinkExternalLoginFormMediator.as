package alternativa.tanks.view
{
   ...
   public class LinkExternalLoginFormMediator extends Mediator
   {
      ...
      private function onExternalLinkAlreadyExists(_arg_1:AuthorizationFailedEvent) : void
      {
         this.view.externalLinkAlreadyExists();
      }
      
      private function onExternalValidation(_arg_1:AuthorizationFailedEvent) : void
      {
