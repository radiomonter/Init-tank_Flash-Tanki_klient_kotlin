package alternativa.tanks.view
{
   ...
   public class StandAloneCaptchaForm extends Sprite
   {
      ...
      public function showCaptcha(_arg_1:Bitmap) : void
      {
      ...
      private function showErrorWindow(_arg_1:int) : void
      {
         ...
         stage.focus = _local_2.closeButton;
      }
      
      public function set captchaAnswer(_arg_1:String) : void
      {
         this.captchaSection.captchaAnswer.textField.text = _arg_1;
      }
   }
}
