package alternativa.utils
{
   ...
   public interface TextureMaterialRegistry
   {
      ...
      function getAnimatedPaint(param1:MultiframeImageResource, param2:TankSkinPartCacheItem) : AnimatedPaintMaterial;
      
      function getPaint(param1:ImageResource, param2:TankSkinPartCacheItem) : PaintMaterial;
