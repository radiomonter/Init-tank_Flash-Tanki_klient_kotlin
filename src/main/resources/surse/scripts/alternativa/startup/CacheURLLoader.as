package alternativa.startup
{
   ...
   public class CacheURLLoader extends URLLoader
   {
      ...
      override public function load(_arg_1:URLRequest) : void
      {
         ...
         var _local_2:Object = this.cacheDirectory.resolvePath(this.encodedUrl);
         if(Boolean(_local_2.exists))
         {
            ...
            super.load(new URLRequest(_local_2.url));
            return;
         }
         this.loadFromServer(_arg_1);
      }
      
      private function loadFromServer(_arg_1:URLRequest) : void
      {
