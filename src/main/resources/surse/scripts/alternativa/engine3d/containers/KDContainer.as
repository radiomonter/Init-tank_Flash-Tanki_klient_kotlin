package alternativa.engine3d.containers
{
   ...
   public class KDContainer extends ConflictContainer
   {
      ...
      public function createTree(param1:Vector.<Object3D>, param2:Vector.<Occluder> = null) : void
      {
         ...
         var _loc7_:int = param2 != null ? int(param2.length) : 0;
      ...
      private function intersectRayNode(param1:KDNode, param2:Vector3D, param3:Vector3D, param4:Dictionary, param5:Camera3D) : RayIntersectionData
      {
         ...
         if(param1.negative != null)
         {
            ...
            if(_loc14_ > 0)
            {
               ...
               _loc7_ = _loc12_ ? param3.x : (_loc13_ ? param3.y : param3.z);
               if(_loc7_ < 0)
               {
      ...
      private function checkIntersectionNode(param1:KDNode, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Dictionary) : Boolean
      {
         ...
         if(param1.negative != null)
         {
            ...
            _loc22_ = _loc19_ ? param5 : (_loc20_ ? param6 : param7);
            if(_loc21_ > 0)
            {
               if(_loc22_ < 0)
               {
      ...
      override alternativa3d function draw(param1:Camera3D) : void
      {
         ...
         var _loc6_:int = param1.debug ? param1.checkInDebug(this) : 0;
         if(Boolean(_loc6_ & Debug.BOUNDS))
         {
         ...
         {
            _loc7_ = param1.debug;
            if(Boolean(_loc6_) && Boolean(_loc6_ & Debug.NODES))
            {
               param1.debug = false;
            }
            _loc3_ = this.opaqueList;
         ...
         if(this.root != null && Boolean(_loc6_ & Debug.NODES))
         {
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:VG = super.alternativa3d::getVG(param1);
         if(this.root != null)
         {
            this.numOccluders = 0;
            calculateInverseMatrix();
      ...
      private function collectVGNode(param1:KDNode, param2:int, param3:Camera3D, param4:VG = null) : VG
      {
         ...
         if(param1.negative != null)
         {
            _loc10_ = param2 > 0 ? this.cullingInContainer(param2,param1.negative.boundMinX,param1.negative.boundMinY,param1.negative.boundMinZ,param1.negative.boundMaxX,param1.negative.boundMaxY,param1.negative.boundMaxZ) : 0;
            _loc11_ = param2 > 0 ? this.cullingInContainer(param2,param1.positive.boundMinX,param1.positive.boundMinY,param1.positive.boundMinZ,param1.positive.boundMaxX,param1.positive.boundMaxY,param1.positive.boundMaxZ) : 0;
            if(_loc10_ >= 0)
            {
      ...
      private function debugNode(param1:KDNode, param2:int, param3:Camera3D, param4:Number) : void
      {
         ...
         {
            _loc5_ = param2 > 0 ? this.cullingInContainer(param2,param1.negative.boundMinX,param1.negative.boundMinY,param1.negative.boundMinZ,param1.negative.boundMaxX,param1.negative.boundMaxY,param1.negative.boundMaxZ) : 0;
            _loc6_ = param2 > 0 ? this.cullingInContainer(param2,param1.positive.boundMinX,param1.positive.boundMinY,param1.positive.boundMinZ,param1.positive.boundMaxX,param1.positive.boundMaxY,param1.positive.boundMaxZ) : 0;
            if(_loc5_ >= 0)
            {
      ...
      private function drawNode(param1:KDNode, param2:int, param3:Camera3D, param4:VG) : void
      {
         ...
         if(param1.negative != null)
         {
            _loc12_ = param2 > 0 || this.numOccluders > 0 ? this.cullingInContainer(param2,param1.negative.boundMinX,param1.negative.boundMinY,param1.negative.boundMinZ,param1.negative.boundMaxX,param1.negative.boundMaxY,param1.negative.boundMaxZ) : 0;
            _loc13_ = param2 > 0 || this.numOccluders > 0 ? this.cullingInContainer(param2,param1.positive.boundMinX,param1.positive.boundMinY,param1.positive.boundMinZ,param1.positive.boundMaxX,param1.positive.boundMaxY,param1.positive.boundMaxZ) : 0;
            ...
            if(_loc12_ >= 0 && _loc13_ >= 0)
            {
               while(param4 != null)
               {
                  ...
                  {
                     _loc16_ = _loc14_ ? param4.boundMinX : (_loc15_ ? param4.boundMinY : param4.boundMinZ);
                     _loc17_ = _loc14_ ? param4.boundMaxX : (_loc15_ ? param4.boundMaxY : param4.boundMaxZ);
      ...
      private function createNode(param1:Object3D, param2:Object3D, param3:Object3D, param4:Object3D, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number) : KDNode
      {
         ...
         else
         {
            ...
            while(_loc14_ != null)
            {
               ...
               _loc14_.next = null;
               _loc15_.next = null;
               _loc37_ = _loc20_ == 0 ? _loc15_.boundMinX : (_loc20_ == 1 ? _loc15_.boundMinY : _loc15_.boundMinZ);
               _loc38_ = _loc20_ == 0 ? _loc15_.boundMaxX : (_loc20_ == 1 ? _loc15_.boundMaxY : _loc15_.boundMaxZ);
      ...
      private function cullingInContainer(param1:int, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : int
      {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.numOccluders)
         {
...
class KDNode
{
   ...
   public function createReceivers(param1:Vector.<Vector.<Number>>, param2:Vector.<Vector.<uint>>) : void
   {
      ...
      var _loc4_:Object3D = this.objectList;
      while(_loc4_ != null)
      {
         _loc4_.composeMatrix();
         _loc5_ = new Receiver();
         ...
         if(_loc9_ > 0 && _loc10_ != null)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc19_.normalX * _loc4_.mi + _loc19_.normalY * _loc4_.mj + _loc19_.normalZ * _loc4_.mk >= -0.5)
               {
                  ...
                  _loc21_ = uint(_loc20_.vertex.index);
                  _loc20_ = _loc20_.next;
                  _loc22_ = uint(_loc20_.vertex.index);
                  _loc20_ = _loc20_.next;
                  while(_loc20_ != null)
                  {
                     _loc23_ = uint(_loc20_.vertex.index);
   ...
   public function collectReceivers(param1:Shadow) : void
   {
      ...
      if(this.negative != null)
      {
         _loc5_ = this.axis == 0;
         _loc6_ = this.axis == 1;
         _loc7_ = _loc5_ ? param1.boundMinX : (_loc6_ ? param1.boundMinY : param1.boundMinZ);
         _loc8_ = _loc5_ ? param1.boundMaxX : (_loc6_ ? param1.boundMaxY : param1.boundMaxZ);
   ...
   public function collectPolygons(param1:Decal, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number) : void
   {
      ...
      if(this.negative != null)
      {
         _loc12_ = this.axis == 0;
         _loc13_ = this.axis == 1;
         _loc14_ = _loc12_ ? param4 : (_loc13_ ? param6 : param8);
         _loc15_ = _loc12_ ? param5 : (_loc13_ ? param7 : param9);
