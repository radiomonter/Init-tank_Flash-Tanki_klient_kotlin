   ...
   public class Box extends Mesh
   {
      ...
      public function Box(param1:Number = 100, param2:Number = 100, param3:Number = 100, param4:uint = 1, param5:uint = 1, param6:uint = 1, param7:Boolean = false, param8:Boolean = false, param9:Material = null, param10:Material = null, param11:Material = null, param12:Material = null, param13:Material = null, param14:Material = null)
      {
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            {
               _loc30_[_loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,_loc16_ * _loc28_ - _loc22_,-_loc23_,(param4 - _loc15_) * _loc24_,(param5 - _loc16_) * _loc25_);
               _loc16_++;
            }
            _loc15_++;
         }
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            while(_loc16_ < _loc19_)
            {
               _loc30_[_loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,_loc16_ * _loc28_ - _loc22_,_loc23_,_loc15_ * _loc24_,(param5 - _loc16_) * _loc25_);
               _loc16_++;
            }
            _loc15_++;
         }
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            {
               _loc30_[_loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,-_loc22_,_loc17_ * _loc29_ - _loc23_,_loc15_ * _loc24_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc15_++;
         }
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            while(_loc17_ < _loc20_)
            {
               _loc30_[_loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,_loc22_,_loc17_ * _loc29_ - _loc23_,(param4 - _loc15_) * _loc24_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc15_++;
         }
         ...
         while(_loc16_ < _loc19_)
         {
            ...
            while(_loc17_ < _loc20_)
            {
               _loc30_[_loc31_++] = this.createVertex(-_loc21_,_loc16_ * _loc28_ - _loc22_,_loc17_ * _loc29_ - _loc23_,(param5 - _loc16_) * _loc25_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc16_++;
         }
         ...
         while(_loc16_ < _loc19_)
         {
            ...
            while(_loc17_ < _loc20_)
            {
               _loc30_[_loc31_++] = this.createVertex(_loc21_,_loc16_ * _loc28_ - _loc22_,_loc17_ * _loc29_ - _loc23_,_loc16_ * _loc25_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc16_++;
         }
