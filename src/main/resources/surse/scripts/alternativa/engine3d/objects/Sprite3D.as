package alternativa.engine3d.objects
{
   ...
   public class Sprite3D extends Object3D
   {
      ...
      override public function intersectRay(param1:Vector3D, param2:Vector3D, param3:Dictionary = null, param4:Camera3D = null) : RayIntersectionData
      {
         ...
         if(param4 == null || Boolean(param3 != null) && Boolean(param3[this]))
         {
            return null;
         }
      ...
      override alternativa3d function draw(param1:Camera3D) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               if(Boolean(_loc2_ & Debug.EDGES))
               {
                  Debug.drawEdges(param1,_loc3_,16777215);
               }
               if(Boolean(_loc2_ & Debug.BOUNDS))
               {
         ...
         while(_loc4_ < param1.omniesCount)
         {
            ...
            if(_loc5_ - _loc8_ < _loc13_ && _loc5_ + _loc8_ > _loc13_ && _loc6_ - _loc8_ < _loc14_ && _loc6_ + _loc8_ > _loc14_ && _loc7_ - _loc8_ < _loc15_ && _loc7_ + _loc8_ > _loc15_)
            {
               ...
               if(_loc16_ > 0 && _loc16_ < _loc8_)
               {
                  ...
                  this.lightConst[0] += _loc12_ * (_loc20_.color >> 16 & 0xFF) / 255;
                  this.lightConst[1] += _loc12_ * (_loc20_.color >> 8 & 0xFF) / 255;
                  this.lightConst[2] += _loc12_ * (_loc20_.color & 0xFF) / 255;
                  this.lighted = true;
               }
            }
            _loc4_++;
            ...
            if(_loc5_ - _loc8_ < _loc13_ && _loc5_ + _loc8_ > _loc13_ && _loc6_ - _loc8_ < _loc14_ && _loc6_ + _loc8_ > _loc14_ && _loc7_ - _loc8_ < _loc15_ && _loc7_ + _loc8_ > _loc15_)
            {
               ...
               if(_loc16_ > 0 && _loc16_ < _loc8_)
               {
                  ...
                  if(_loc22_ > _loc23_)
                  {
                     ...
                     this.lightConst[0] += _loc12_ * (_loc21_.color >> 16 & 0xFF) / 255;
                     this.lightConst[1] += _loc12_ * (_loc21_.color >> 8 & 0xFF) / 255;
                     this.lightConst[2] += _loc12_ * (_loc21_.color & 0xFF) / 255;
                     this.lighted = true;
                  }
               }
            }
         ...
         while(_loc4_ < param1.tubesCount)
         {
            ...
            if(_loc30_ > -_loc26_ && _loc30_ < _loc26_)
            {
               ...
               if(_loc16_ > 0 && _loc16_ < _loc24_.attenuationEnd)
               {
                  ...
                  this.lightConst[0] += _loc12_ * (_loc24_.color >> 16 & 0xFF) / 255;
                  this.lightConst[1] += _loc12_ * (_loc24_.color >> 8 & 0xFF) / 255;
                  this.lightConst[2] += _loc12_ * (_loc24_.color & 0xFF) / 255;
                  this.lighted = true;
               }
            }
            _loc4_++;
      ...
      private function calculateFace(param1:Camera3D) : Face
      {
         ...
         else
         {
            ...
            if(culling > 0)
            {
               if(this.clipping == 1)
               {
                  if(Boolean(culling & 4 && _loc2_ <= -_loc3_ && _loc2_ <= -_loc5_) && Boolean(_loc2_ <= -_loc7_) && _loc2_ <= -_loc9_)
                  {
                     return null;
                  }
                  if(Boolean(culling & 8 && _loc2_ <= _loc3_ && _loc2_ <= _loc5_) && Boolean(_loc2_ <= _loc7_) && _loc2_ <= _loc9_)
                  {
                     return null;
                  }
                  if(Boolean(culling & 0x10 && _loc2_ <= -_loc4_ && _loc2_ <= -_loc6_) && Boolean(_loc2_ <= -_loc8_) && _loc2_ <= -_loc10_)
                  {
                     return null;
                  }
                  if(Boolean(culling & 0x20 && _loc2_ <= _loc4_ && _loc2_ <= _loc6_) && Boolean(_loc2_ <= _loc8_) && _loc2_ <= _loc10_)
                  {
                     return null;
                  }
                  _loc11_ = Vertex.createList(4);
