package alternativa.engine3d.objects
{
   ...
   public class BSP extends Object3D
   {
      ...
      public function setMaterialToAllFaces(param1:Material) : void
      {
         ...
         this.deleteResources();
         var _loc2_:int = int(this.faces.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      {
         if(Boolean(param3 != null) && Boolean(param3[this]) || this.root == null)
         {
            return null;
         }
      ...
      {
         if(Boolean(param7 != null) && Boolean(param7[this]) || this.root == null)
         {
            return;
         }
      ...
      override protected function clonePropertiesFrom(param1:Object3D) : void
      {
         ...
         var _loc6_:int = int(_loc2_.faces.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
      ...
      override alternativa3d function draw(param1:Camera3D) : void
      {
         ...
         var _loc2_:int = param1.debug ? param1.checkInDebug(this) : 0;
      ...
      alternativa3d function prepareResources() : void
      {
         ...
         if(this.vertexBuffer == null)
         {
            ...
            for each(_loc7_ in this.faces)
            {
               ...
               _loc9_ = uint(_loc8_.vertex.index);
               _loc8_ = _loc8_.next;
               _loc10_ = uint(_loc8_.vertex.index);
               _loc8_ = _loc8_.next;
               while(_loc8_ != null)
               {
                  _loc11_ = uint(_loc8_.vertex.index);
      ...
      override alternativa3d function split(param1:Vector3D, param2:Vector3D, param3:Vector3D, param4:Number) : Vector.<Object3D>
      {
         ...
         var _loc18_:int = 0;
         var _loc19_:int = 0;
         var _loc20_:int = int(_loc11_.length);
         var _loc21_:int = 0;
      ...
      private function collectVertices() : void
      {
         ...
         var _loc4_:Wrapper = null;
         var _loc5_:Vertex = null;
         var _loc1_:int = int(this.faces.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
