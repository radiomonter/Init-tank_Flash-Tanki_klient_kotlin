   ...
   public class SpotLight extends Light3D
   {
      ...
      override alternativa3d function drawDebug(param1:Camera3D) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            if(Boolean(_loc2_ & Debug.LIGHTS) && ml > param1.nearClipping)
            {
      ...
      override alternativa3d function updateBounds(param1:Object3D, param2:Object3D = null) : void
      {
         ...
         var _loc3_:Number = this.falloff < Math.PI ? Math.sin(this.falloff / 2) * this.attenuationEnd : this.attenuationEnd;
         var _loc4_:Number = this.falloff < Math.PI ? 0 : Math.cos(this.falloff / 2) * this.attenuationEnd;
         if(param2 != null)
         {
