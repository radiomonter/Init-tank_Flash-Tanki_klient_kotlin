      ...
      alternativa3d function render(param1:Camera3D, param2:Number, param3:Number, param4:Number, param5:Boolean, param6:Boolean, param7:Number, param8:Vector.<Object3D>, param9:int) : void
      {
         ...
         if(param6)
         {
            ...
            while(_loc10_ < param1.omniesCount)
            {
               ...
               _loc21_++;
               this.lightConst[_loc21_] = _loc23_.intensity * param1.deferredLightingStrength * (_loc23_.color >> 16 & 0xFF) / 255;
               _loc21_++;
               this.lightConst[_loc21_] = _loc23_.intensity * param1.deferredLightingStrength * (_loc23_.color >> 8 & 0xFF) / 255;
               _loc21_++;
               this.lightConst[_loc21_] = _loc23_.intensity * param1.deferredLightingStrength * (_loc23_.color & 0xFF) / 255;
               _loc21_++;
            ...
            while(_loc10_ < param1.tubesCount)
            {
               ...
               _loc21_++;
               this.lightConst[_loc21_] = _loc27_.intensity * param1.deferredLightingStrength * (_loc27_.color >> 16 & 0xFF) / 255;
               _loc21_++;
               this.lightConst[_loc21_] = _loc27_.intensity * param1.deferredLightingStrength * (_loc27_.color >> 8 & 0xFF) / 255;
               _loc21_++;
               this.lightConst[_loc21_] = _loc27_.intensity * param1.deferredLightingStrength * (_loc27_.color & 0xFF) / 255;
               _loc21_++;
