package alternativa.engine3d.core
{
   ...
   public class Light3D extends Object3D
   {
      ...
      alternativa3d function checkBoundsIntersection(param1:Object3D) : Boolean
      {
         ...
         _loc2_ = 0;
         _loc3_ = _loc8_ >= 0 ? _loc8_ : -_loc8_;
         _loc2_ += _loc3_;
         _loc3_ = _loc11_ >= 0 ? _loc11_ : -_loc11_;
         _loc2_ += _loc3_;
         _loc3_ = _loc14_ >= 0 ? _loc14_ : -_loc14_;
         _loc2_ += _loc3_;
         _loc2_ += _loc17_;
         _loc3_ = _loc20_ >= 0 ? _loc20_ : -_loc20_;
         _loc2_ -= _loc3_;
         if(_loc2_ <= 0)
         {
            return false;
         ...
         _loc2_ += _loc3_;
         _loc2_ += _loc17_;
         _loc3_ = _loc21_ >= 0 ? _loc21_ : -_loc21_;
         _loc2_ -= _loc3_;
         if(_loc2_ <= 0)
         {
            return false;
         ...
         _loc3_ = _loc3_ >= 0 ? _loc3_ : -_loc3_;
         _loc2_ += _loc3_;
         _loc3_ = this.oma >= 0 ? this.oma * _loc16_ : -this.oma * _loc16_;
         _loc2_ += _loc3_;
         _loc3_ = this.ome >= 0 ? this.ome * _loc17_ : -this.ome * _loc17_;
         _loc2_ += _loc3_;
         _loc3_ = this.omi >= 0 ? this.omi * _loc18_ : -this.omi * _loc18_;
         _loc2_ += _loc3_;
         ...
         _loc3_ = _loc3_ >= 0 ? _loc3_ : -_loc3_;
         _loc2_ += _loc3_;
         _loc3_ = this.omb >= 0 ? this.omb * _loc16_ : -this.omb * _loc16_;
         _loc2_ += _loc3_;
         _loc3_ = this.omf >= 0 ? this.omf * _loc17_ : -this.omf * _loc17_;
         _loc2_ += _loc3_;
         _loc3_ = this.omj >= 0 ? this.omj * _loc18_ : -this.omj * _loc18_;
         _loc2_ += _loc3_;
         ...
         _loc3_ = _loc3_ >= 0 ? _loc3_ : -_loc3_;
         _loc2_ += _loc3_;
         _loc3_ = this.omc >= 0 ? this.omc * _loc16_ : -this.omc * _loc16_;
         _loc2_ += _loc3_;
         _loc3_ = this.omg >= 0 ? this.omg * _loc17_ : -this.omg * _loc17_;
         _loc2_ += _loc3_;
         _loc3_ = this.omk >= 0 ? this.omk * _loc18_ : -this.omk * _loc18_;
         _loc2_ += _loc3_;
