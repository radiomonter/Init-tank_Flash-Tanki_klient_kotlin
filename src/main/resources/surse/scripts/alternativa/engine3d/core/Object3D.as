package alternativa.engine3d.core
{
   ...
   public class Object3D implements IEventDispatcher
   {
      ...
      {
         return this.captureListeners != null && Boolean(this.captureListeners[param1]) || this.bubbleListeners != null && Boolean(this.bubbleListeners[param1]);
      }
      ...
      public function willTrigger(param1:String) : Boolean
      {
         ...
         while(_loc2_ != null)
         {
            if(Boolean(_loc2_.captureListeners != null) && Boolean(_loc2_.captureListeners[param1]) || Boolean(_loc2_.bubbleListeners != null) && Boolean(_loc2_.bubbleListeners[param1]))
            {
               return true;
            }
            _loc2_ = _loc2_._parent;
