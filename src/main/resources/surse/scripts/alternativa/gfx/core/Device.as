package alternativa.gfx.core
{
   ...
   public class Device extends EventDispatcher
   {
      ...
      {
         var _local_3:TextureResource = null;
         var _local_4:VertexBufferResource = null;
         var _local_6:int = 0;
         ...
         var _local_5:Context3D = this._stage3D.context3D;
         _local_5.enableErrorChecking = this._enableErrorChecking;
         for(_local_2 in this.resourcesToUpload)
         {
            this.uploadResource(_local_2);
            delete this.resourcesToUpload[_local_2];
         }
         _local_5.setBlendFactors(this._renderState.blendSourceFactor,this._renderState.blendDestinationFactor);
         _local_5.setColorMask(this._renderState.colorMaskRed,this._renderState.colorMaskGreen,this._renderState.colorMaskBlue,this._renderState.colorMaskAlpha);
         _local_5.setCulling(this._renderState.culling);
         _local_5.setDepthTest(this._renderState.depthTestMask,this._renderState.depthTestPassCompareMode);
         if(this._renderState.program != null)
         {
            ...
            this.prepareResource(_local_5,this._renderState.program);
            _local_5.setProgram(this._renderState.program.program);
         }
         if(this._renderState.renderTarget != null)
         {
            ...
            this.prepareResource(_local_5,this._renderState.renderTarget);
            _local_5.setRenderToTexture(this._renderState.renderTarget.texture,this._renderState.renderTargetEnableDepthAndStencil,this._renderState.renderTargetAntiAlias,this._renderState.renderTargetSurfaceSelector);
         }
         if(this._renderState.scissor)
         {
            _local_5.setScissorRectangle(this._renderState.scissorRectangle);
         }
         else
         {
            _local_5.setScissorRectangle(null);
         }
         _local_5.setStencilActions(this._renderState.stencilActionTriangleFace,this._renderState.stencilActionCompareMode,this._renderState.stencilActionOnBothPass,this._renderState.stencilActionOnDepthFail,this._renderState.stencilActionOnDepthPassStencilFail);
         _local_5.setStencilReferenceValue(this._renderState.stencilReferenceValue,this._renderState.stencilReadMask,this._renderState.stencilWriteMask);
         while(_local_6 < 8)
         {
            _local_3 = this._renderState.textures[_local_6];
            if(_local_3 != null)
            {
               if(!_local_3.available)
               {
                  throw new Error(RESOURCE_NOT_AVAILABLE_ERROR);
               }
               this.prepareResource(_local_5,_local_3);
               _local_5.setTextureAt(_local_6,_local_3.texture);
            }
            _local_4 = this._renderState.vertexBuffers[_local_6];
            if(_local_4 != null)
            {
               if(!_local_4.available)
               {
                  throw new Error(RESOURCE_NOT_AVAILABLE_ERROR);
               }
               this.prepareResource(_local_5,_local_4);
               _local_5.setVertexBufferAt(_local_6,_local_4.buffer,this._renderState.vertexBuffersOffsets[_local_6],this._renderState.vertexBuffersFormats[_local_6]);
            }
            _local_6++;
         }
         _local_5.setProgramConstantsFromVector(Context3DProgramType.VERTEX,0,this._renderState.vertexConstants,128);
         _local_5.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT,0,this._renderState.fragmentConstants,28);
      ...
      public function setStencilReferenceValue(_arg_1:uint, _arg_2:uint = 255, _arg_3:uint = 255) : void
      {
         var _local_4:Context3D = null;
      ...
      public function setProgramConstantsFromVector(_arg_1:String, _arg_2:int, _arg_3:Vector.<Number>, _arg_4:int = -1, _arg_5:Boolean = true) : void
      {
         ...
         var _local_10:* = _arg_2 << 2;
         var _local_11:int = _arg_4 < 0 ? int(_arg_3.length) : int(_arg_4 << 2);
         var _local_12:Vector.<Number> = _arg_1 == "vertex" ? this._renderState.vertexConstants : this._renderState.fragmentConstants;
         if(_arg_5)
         {
            _local_7 = false;
            while(_local_9 < _local_11)
            {
               _local_8 = _arg_3[_local_9];
               if(_local_8 != _local_12[_local_10])
               {
         ...
         else
         {
            while(_local_9 < _local_11)
            {
               _local_12[_local_10] = _arg_3[_local_9];
               _local_9++;
               _local_10++;
            }
            _local_6 = this._stage3D.context3D;
      ...
      public function clear(_arg_1:Number = 0, _arg_2:Number = 0, _arg_3:Number = 0, _arg_4:Number = 1, _arg_5:Number = 1, _arg_6:uint = 0, _arg_7:uint = 4294967295) : void
      {
         var _local_8:int = 0;
         var _local_9:int = 0;
         var _local_10:int = 0;
         var _local_11:int = 0;
         var _local_12:int = 0;
         var _local_13:Context3D = this._stage3D.context3D;
         if(_local_13 != null)
         {
            if(!this.configured)
            {
               _local_8 = 50;
               _local_9 = this._width;
               _local_10 = this._height;
               if(this._profile == "baselineConstrained")
               {
                  ...
                  if(_local_11 + _local_9 > this.stage.stageWidth)
                  {
                     _local_9 = this.stage.stageWidth - _local_11;
                  }
                  if(_local_12 + _local_10 > this.stage.stageHeight)
                  {
                     _local_10 = this.stage.stageHeight - _local_12;
                  }
                  if(_local_11 != this._stage3D.x || _local_12 != this._stage3D.y || _local_9 != this.backBufferWidth || _local_10 != this.backBufferHeight || this._enableDepthAndStencil != this.backBufferEnableDepthAndStencil)
                  {
                     _local_13.configureBackBuffer(_local_8,_local_8,0,this._enableDepthAndStencil);
                     this._stage3D.x = _local_11;
                     this._stage3D.y = _local_12;
                     _local_13.configureBackBuffer(_local_9,_local_10,0,this._enableDepthAndStencil);
                     this.backBufferWidth = _local_9;
                     this.backBufferHeight = _local_10;
               ...
               else
               {
                  ...
                  if(_local_9 != this.backBufferWidth || _local_10 != this.backBufferHeight || this._antiAlias != this.backBufferAntiAlias || this._enableDepthAndStencil != this.backBufferEnableDepthAndStencil)
                  {
                     _local_13.configureBackBuffer(_local_9,_local_10,this._antiAlias,this._enableDepthAndStencil);
                     this.backBufferWidth = _local_9;
                     this.backBufferHeight = _local_10;
                     this.backBufferAntiAlias = this._antiAlias;
                     this.backBufferEnableDepthAndStencil = this._enableDepthAndStencil;
            ...
            _local_13.clear(_arg_1,_arg_2,_arg_3,_arg_4,_arg_5,_arg_6,_arg_7);
         }
      }
