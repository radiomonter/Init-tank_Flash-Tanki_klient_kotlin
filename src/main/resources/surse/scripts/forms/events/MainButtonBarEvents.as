package forms.events
{
   ...
   public class MainButtonBarEvents extends Event
   {
      ...
      public static const pujoza:String = "DailyQuests";
      
      public static const PANEL_BUTTON_PRESSED:String = "Close";
      
      private var types:Array = new Array(ADDMONEY,RATING,CHALLENGE,BATTLE,GARAGE,STAT,SETTINGS,SOUND,HELP,CLOSE,BUGS,EXCHANGE,REFERAL,FRIENDS,pujoza,FULL_SCREEN,CLAN);
      
      private var _typeButton:String;
      
      public function MainButtonBarEvents(_arg_1:int)
      {
         super(MainButtonBarEvents.PANEL_BUTTON_PRESSED,true,false);
         this._typeButton = this.types[_arg_1 - 1];
      }
