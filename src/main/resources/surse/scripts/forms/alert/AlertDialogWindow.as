package forms.alert
{
   ...
   public class AlertDialogWindow extends DialogWindow
   {
      ...
      public function AlertDialogWindow(_arg_1:BitmapData, _arg_2:String)
      {
         super();
         this._headerBitmapData = _arg_1;
         this._cancelButtonText = _arg_2;
         this.init();
      }
      ...
      protected function setContentPlaceSize(_arg_1:int, _arg_2:int) : void
      {
         this._contentPlaceWidth = _arg_1;
         this._contentPlaceHeight = _arg_2;
         this.resize();
      }
      
      protected function setButtonPlaceHeight(_arg_1:int) : void
      {
         this._buttonPlaceHeight = _arg_1;
         this.resize();
      }
      ...
      protected function onCancel(_arg_1:Event = null) : void
      {
         this.destroy();
      }
