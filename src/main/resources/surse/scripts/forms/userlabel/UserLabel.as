package forms.userlabel
{
   ...
   public class UserLabel extends Sprite
   {
      ...
      public function UserLabel(_arg_1:String)
      {
         super();
         if(_arg_1 == null)
         {
      ...
      private function createRankIcon() : void
      {
         ...
         _local_1.graphics.beginFill(65535,0);
         _local_1.graphics.drawRect(0,0,RANK_ICON_CONT_WIDTH,RANK_ICON_CONT_HEIGHT);
         _local_1.graphics.endFill();
         this._rankIcon = new SmallRankIcon();
         _local_1.addChild(this._rankIcon);
         this.shadowContainer.addChild(_local_1);
      ...
      protected function onMouseClick(_arg_1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            contextMenuService.show(display.stage.mouseX,display.stage.mouseY,this._userId,this._rank,this._uid,_local_2,_local_3,_local_4,_local_5,_local_6,this._writeInChat,this._inviteBattleEnable,this._focusOnUserEnabled,this._blockUserEnable);
         }
      }
      ...
      private function onChangeUid(_arg_1:UserInfoLabelUpdaterEvent) : void
      {
         this.setUid(this._userInfoUpdater.uid);
      }
      
      protected function setUid(_arg_1:String) : void
      {
         if(!this._isInitUid)
         {
         ...
         this._uid = _arg_1;
         var _local_2:String = this._uid + this._additionalText;
         if(this._uidLabel.text == _local_2)
         {
            return;
         }
         this._uidLabel.text = _local_2;
         dispatchEvent(new ChatUpdateEvent(ChatUpdateEvent.UPDATE,true));
      }
      
      public function setAdditionalText(_arg_1:String) : void
      {
         this._additionalText = _arg_1;
         this.setUid(this._uid);
      }
      
      private function onChangeRank(_arg_1:UserInfoLabelUpdaterEvent) : void
      {
         this.setRank(this._userInfoUpdater.rank);
      }
      
      private function onChangePremiumStatus(_arg_1:Event = null) : void
      {
         this.updateProperties();
      }
      
      protected function setRank(_arg_1:int) : void
      {
         this._rank = _arg_1;
      ...
      private function onChangeFriendState(_arg_1:FriendInfoLabelUpdaterEvent) : void
      {
         this.setFriendState(this._friendInfoUpdater.state);
      }
      
      protected function setFriendState(_arg_1:FriendState) : void
      {
         this._friendState = _arg_1;
      ...
      public function setUidColor(_arg_1:uint, _arg_2:Boolean = false) : void
      {
         this._lastUidColor = _arg_1;
         this._ignoreFriendsColor = _arg_2;
         this._uidLabel.color = _arg_1;
         this.refreshFriendState();
      }
      ...
      public function set inviteBattleEnable(_arg_1:Boolean) : void
      {
         this._inviteBattleEnable = _arg_1;
      }
