package projects.tanks.client.garage.models.garage.upgrade
{
   ...
   public class UpgradeGarageItemModelBase extends Model
   {
      ...
      private var modelId:Long = Long.getLong(0,300040024);
      
      private var _itemAlreadyUpgradedId:Long = Long.getLong(0,300040014);
      ...
      protected function getInitParam() : UpgradeGarageItemCC
      {
         return UpgradeGarageItemCC(initParams[Model.object]);
      }
