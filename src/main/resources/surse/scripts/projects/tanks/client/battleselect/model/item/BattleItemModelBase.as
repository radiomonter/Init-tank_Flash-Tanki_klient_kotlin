      ...
      override public function invoke(_arg_1:Long, _arg_2:ProtocolBuffer) : void
      {
         switch(_arg_1)
         {
            ...
            case this._updateNameId:
               this.client.updateName(String(this._updateName_newNameCodec.decode(_arg_2)));
               return;
            case this._updateSuspiciousId:
               this.client.updateSuspicious(Boolean(this._updateSuspicious_suspiciousCodec.decode(_arg_2)));
         }
      }
