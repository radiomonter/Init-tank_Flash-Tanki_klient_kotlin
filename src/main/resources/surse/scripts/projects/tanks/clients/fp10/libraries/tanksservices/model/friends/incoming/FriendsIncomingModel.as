package projects.tanks.clients.fp10.libraries.tanksservices.model.friends.incoming
{
   ...
   public class FriendsIncomingModel
   {
      ...
      public function objectLoaded(_arg_1:UserContainerCC) : void
      {
         ...
         {
            friendsInfoService.setFriendState(_local_3,FriendState.INCOMING);
         }
      }
      
      public function onAdding(_arg_1:String) : void
      {
         friendsInfoService.setFriendState(_arg_1,FriendState.INCOMING);
      }
      
      public function onRemoved(_arg_1:String) : void
      {
         friendsInfoService.deleteFriend(_arg_1,FriendState.INCOMING);
      }
   }
}
