package projects.tanks.clients.flash.commons.services.notification
{
   ...
   public class Notification extends Sprite implements INotification
   {
      ...
      public function Notification(_arg_1:String = null, _arg_2:String = "", _arg_3:Boolean = true)
      {
         super();
         this._userId = _arg_1;
         this._message = _arg_2;
         this._autoClosable = _arg_3;
         this.init();
      }
      ...
      private function onCloseNotification(_arg_1:MouseEvent) : void
      {
      ...
      public function show(_arg_1:Signal) : void
      {
         this._closeSignal = _arg_1;
         this.resize();
         this._isShow = true;
         display.noticesLayer.addChild(this);
         var _local_2:int = display.stage.stageWidth - this._width;
         TweenLite.to(this,DURATION_SHOW,{
            "x":display.stage.stageWidth - this._width,
            "ease":Linear.easeNone,
            "onComplete":this.onCompleteShow
         });
         myzywak.playNotificationSound();
      }
      ...
      public function set autoClosable(_arg_1:Boolean) : void
      {
         this._autoClosable = _arg_1;
      }
   }
}
