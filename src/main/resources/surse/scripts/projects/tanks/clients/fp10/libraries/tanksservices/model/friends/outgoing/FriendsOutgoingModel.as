package projects.tanks.clients.fp10.libraries.tanksservices.model.friends.outgoing
{
   ...
   public class FriendsOutgoingModel
   {
      ...
      public function objectLoaded(_arg_1:UserContainerCC) : void
      {
         ...
         {
            friendsInfoService.setFriendState(_local_3,FriendState.OUTGOING);
         }
      }
      
      public function onAdding(_arg_1:String) : void
      {
         friendsInfoService.setFriendState(_arg_1,FriendState.OUTGOING);
      }
      
      public function onRemoved(_arg_1:String) : void
      {
         friendsInfoService.deleteFriend(_arg_1,FriendState.OUTGOING);
      }
   }
}
