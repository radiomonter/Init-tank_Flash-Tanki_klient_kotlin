package projects.tanks.clients.flash.resourcesflash
{
   ...
   public class Activator implements IBundleActivator
   {
      ...
      public function start(param1:OSGi) : void
      {
         ...
         {
            Tanks3DSResource.resourceLocalStorage = IResourceLocalStorage(_arg_1);
         ...
         {
            MapResource.resourceRegistry = ResourceRegistry(_arg_1);
         ...
         osgi.injectService(IResourceLocalStorage,function(_arg_1:Object):void
         {
            PropLibResource.resourceLocalStorage = IResourceLocalStorage(_arg_1);
         },function():IResourceLocalStorage
         {
         ...
         osgi.injectService(ResourceRegistry,function(_arg_1:Object):void
         {
            Object3DSModel.resourceRegistry = ResourceRegistry(_arg_1);
         },function():ResourceRegistry
         {
