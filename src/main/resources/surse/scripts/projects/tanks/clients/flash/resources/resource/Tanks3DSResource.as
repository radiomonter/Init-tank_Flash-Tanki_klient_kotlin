package projects.tanks.clients.flash.resources.resource
{
   ...
   public class Tanks3DSResource extends Resource
   {
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, state %2 ",this,this.loadingState);
         switch(this.loadingState)
         {
            case LOADING_STATE_TEXTURE_INFO:
            case LOADING_STATE_TEXTURES:
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, loading texture info... %2",this,baseUrl + IMAGES_FILE);
      ...
      private function onImagesXMLLoadingComplete(param1:Event) : void
      {
         ...
         OSGi.clientLog.log("resource","Reloading resource %1, loaded texture info.., file name=%2",this,_loc3_.name());
         this.destroyTextureInfoLoader();
         if(_loc3_.name() != "images")
         {
            OSGi.clientLog.log("resource","Invalid map.xml contents. ResourceId=" + this.id);
         ...
         if(_loc5_ > 0)
         {
            OSGi.clientLog.log("resource","Reloading resource %1, loading textures...",this);
         ...
         {
            OSGi.clientLog.log("resource","Reloading resource %1, textures skipped, loading model...",this);
            this.loadModel();
         }
      }
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, BatchLoadingError",this);
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, batch loading completed...",this);
         var _loc2_:* = null;
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, loading model...",this);
         this.urlLoader = new SafeURLLoader();
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, loaded model...",this);
      ...
      private function buildResourceData() : void
      {
         ...
         var _loc3_:int = 0;
         OSGi.clientLog.log("resource","Reloading resource %1, building resource data...",this);
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, model textures complete...",this);
      ...
      {
         OSGi.clientLog.log("resource","Reloading resource %1, completeResourceLoading",this);
...
class BatchTextureConstructor extends EventDispatcher implements ITextureConstructorListener
{
   ...
   internal var entries:Vector.<ImageData>;
   
   internal var maxBatchSize:int;
   
   internal var batchSize:int;
   
   internal var firstBatchIndex:int;
   
   internal var batchCouner:int;
   
   internal var totalCounter:int;
   
   internal var constructors:Vector.<IndexedTextureConstructor>;
   ...
   internal function createBatch() : void
   {
