package utils
{
   ...
   public class Pen
   {
      ...
      public function drawTriangle(_arg_1:Number, _arg_2:Number, _arg_3:Number, _arg_4:Number, _arg_5:Number, _arg_6:Number = 0) : void
      {
         ...
         this.drawLine(-_local_11 + _arg_1,-_local_12 + _arg_2,_local_9 - _local_11 + _arg_1,_local_10 - _local_12 + _arg_2);
         this.lineTo(_local_7 - _local_11 + _arg_1,_local_8 - _local_12 + _arg_2);
         this.lineTo(-_local_11 + _arg_1,-_local_12 + _arg_2);
      }
