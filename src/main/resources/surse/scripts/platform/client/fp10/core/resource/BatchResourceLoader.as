package platform.client.fp10.core.resource
{
   ...
   public class BatchResourceLoader implements IResourceLoadingListener, AutoClosable
   {
      ...
      {
         ++this.numResources;
         getLogger().debug("loadResource, numResources= %1",[this.numResources]);
      ...
      public function onResourceLoadingComplete(param1:Resource) : void
      {
         ...
         getLogger().debug("Resource loading complete, numLoadedResources= %1, numResources= %2",[this.numLoadedResources,this.numResources]);
      ...
      {
         getLogger().error("resource: %1, fatal error: %2",[param1,param2]);
