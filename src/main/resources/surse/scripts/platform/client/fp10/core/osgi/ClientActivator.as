package platform.client.fp10.core.osgi
{
   ...
   public class ClientActivator implements IBundleActivator
   {
      ...
      {
         var _local_1:IProtocol = IProtocol(this.osgi.getService(IProtocol));
         _local_1.registerCodecForType(ControlCommand,new ControlRootCodec());
         _local_1.registerCodecForType(SpaceCommand,new SpaceRootCodec());
         _local_1.registerCodecForType(IGameObject,new GameObjectCodec());
      }
      ...
      private function registerServices() : void
      {
         ...
         var _local_1:ILauncherParams = ILauncherParams(this.osgi.getService(ILauncherParams));
      ...
      {
         var _local_1:ResourceRegistry = ResourceRegistry(this.osgi.getService(ResourceRegistry));
         _local_1.registerTypeClasses(ResourceType.SWF_LIBRARY,SWFLibraryResource);
         _local_1.registerTypeClasses(ResourceType.IMAGE,ImageResource);
         _local_1.registerTypeClasses(ResourceType.LOCALIZED_IMAGE,LocalizedImageResource);
         _local_1.registerTypeClasses(ResourceType.MULTIFRAME_IMAGE,MultiframeImageResource);
         _local_1.registerTypeClasses(ResourceType.SOUND,SoundResource);
         _local_1.registerTypeClasses(ResourceType.MODEL_3DS,Resource3DS);
      }
      
      private function createConnection() : void
      {
         var _local_1:IProtocol = IProtocol(this.osgi.getService(IProtocol));
         var _local_2:ITransportService = ITransportService(this.osgi.getService(ITransportService));
         var _local_3:INetworkService = INetworkService(this.osgi.getService(INetworkService));
      }
