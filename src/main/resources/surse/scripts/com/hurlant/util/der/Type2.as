package com.hurlant.util.der
{
   ...
   public class Type2
   {
      ...
      public static function Attribute(_arg_1:ASN1Type, _arg_2:OIDType):ASN1Type
      {
         return sequence({"type":_arg_2},{"values":setOf(_arg_1,1,MAX)});
      }
      ...
      public static function directoryString(_arg_1:int):ASN1Type
      {
         return choice({"teletexString":teletexString(1,_arg_1)},{"printableString":printableString(1,_arg_1)},{"universalString":universalString(1,_arg_1)},{"bmpString":bmpString(1,_arg_1)},{"utf8String":utf8String(1,_arg_1)});
      }
      public static function pkcs9string(_arg_1:int):ASN1Type
      {
         return choice({"utf8String":utf8String(1,_arg_1)},{"directoryString":directoryString(_arg_1)});
      }
      ...
      public static function signed(_arg_1:ASN1Type):ASN1Type
      {
         return sequence({"toBeSigned":extract(_arg_1)},{"algorithm":AlgorithmIdentifier},{"signature":bitString()});
      }
