package com.hurlant.crypto.tls
{
   public class CipherSuites
   {
      ...
      public function CipherSuites(_arg_1:uint, _arg_2:uint, _arg_3:uint)
      {
         super();
         this.cipher = _arg_1;
         this.hash = _arg_2;
      ...
      private static function getProp(_arg_1:uint) : CipherSuites
      {
         var _local_2:CipherSuites = _props[_arg_1];
         if(_local_2 == null)
         {
            throw new Error("Unknown cipher " + _arg_1.toString(16));
         }
         return _local_2;
      }
      
      public static function getBulkCipher(_arg_1:uint) : uint
      {
         return getProp(_arg_1).cipher;
      }
      
      public static function getMac(_arg_1:uint) : uint
      {
         return getProp(_arg_1).hash;
      }
      
      public static function getKeyExchange(_arg_1:uint) : uint
      {
         return getProp(_arg_1).key;
      }
