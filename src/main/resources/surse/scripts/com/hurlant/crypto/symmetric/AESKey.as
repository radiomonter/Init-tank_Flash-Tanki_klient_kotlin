package com.hurlant.crypto.symmetric
{
   ...
   public class AESKey implements ISymmetricKey
   {
      ...
      (function():void
      {
         ...
         while(_local_1 < 256)
         {
            Sbox[_local_1] = _Sbox[_local_1];
            InvSbox[_local_1] = _InvSbox[_local_1];
            Xtime2Sbox[_local_1] = _Xtime2Sbox[_local_1];
            Xtime3Sbox[_local_1] = _Xtime3Sbox[_local_1];
            Xtime2[_local_1] = _Xtime2[_local_1];
            Xtime9[_local_1] = _Xtime9[_local_1];
            XtimeB[_local_1] = _XtimeB[_local_1];
            XtimeD[_local_1] = _XtimeD[_local_1];
            XtimeE[_local_1] = _XtimeE[_local_1];
            _local_1++;
         }
         Rcon = new ByteArray();
         _local_1 = 0;
         while(_local_1 < _Rcon.length)
         {
            Rcon[_local_1] = _Rcon[_local_1];
            _local_1++;
         }
      })();
      ...
      private function expandKey() : void
      {
         ...
         {
            _local_1 = uint(this.key[4 * _local_6 - 4]);
            _local_2 = uint(this.key[4 * _local_6 - 3]);
            _local_3 = uint(this.key[4 * _local_6 - 2]);
            _local_4 = uint(this.key[4 * _local_6 - 1]);
            if(!(_local_6 % _local_7))
            {
               _local_5 = _local_4;
               _local_4 = uint(Sbox[_local_1]);
               _local_1 = uint(Sbox[_local_2] ^ Rcon[_local_6 / _local_7]);
               _local_2 = uint(Sbox[_local_3]);
               _local_3 = uint(Sbox[_local_5]);
            }
            else if(_local_7 > 6 && _local_6 % _local_7 == 4)
            {
               _local_1 = uint(Sbox[_local_1]);
               _local_2 = uint(Sbox[_local_2]);
               _local_3 = uint(Sbox[_local_3]);
               _local_4 = uint(Sbox[_local_4]);
            }
      ...
      protected function invShiftRows() : void
      {
         ...
         _local_1 = uint(InvSbox[this.state[13]]);
         ...
         _local_1 = uint(InvSbox[this.state[2]]);
         this.state[2] = InvSbox[this.state[10]];
         this.state[10] = _local_1;
         _local_1 = uint(InvSbox[this.state[6]]);
         this.state[6] = InvSbox[this.state[14]];
         this.state[14] = _local_1;
         _local_1 = uint(InvSbox[this.state[3]]);
      ...
      protected function addRoundKey(_arg_1:ByteArray, _arg_2:uint) : void
      {
         ...
         while(_local_3 < 16)
         {
            this.state[_local_3] ^= _arg_1[_local_3 + _arg_2];
            _local_3++;
         }
      }
