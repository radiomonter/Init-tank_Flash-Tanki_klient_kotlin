package com.hurlant.crypto.hash
{
   public class SHA256 extends SHABase implements IHash
   {
      ...
      override protected function core(_arg_1:Array, _arg_2:uint) : Array
      {
         ...
         var _local_3:Array = [];
         var _local_4:uint = uint(this.h[0]);
         var _local_5:uint = uint(this.h[1]);
         var _local_6:uint = uint(this.h[2]);
         var _local_7:uint = uint(this.h[3]);
         var _local_8:uint = uint(this.h[4]);
         var _local_9:uint = uint(this.h[5]);
         var _local_10:uint = uint(this.h[6]);
         var _local_11:uint = uint(this.h[7]);
         while(_local_12 < _arg_1.length)
         {
            ...
            while(_local_21 < 64)
            {
               ...
               {
                  _local_24 = uint(this.rrol(_local_3[_local_21 - 15],7) ^ this.rrol(_local_3[_local_21 - 15],18) ^ _local_3[_local_21 - 15] >>> 3);
                  _local_25 = uint(this.rrol(_local_3[_local_21 - 2],17) ^ this.rrol(_local_3[_local_21 - 2],19) ^ _local_3[_local_21 - 2] >>> 10);
