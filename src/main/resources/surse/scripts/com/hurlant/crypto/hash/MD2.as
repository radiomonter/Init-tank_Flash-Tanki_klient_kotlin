package com.hurlant.crypto.hash
{
   ...
   public class MD2 implements IHash
   {
      ...
      public function hash(_arg_1:ByteArray) : ByteArray
      {
         ...
         var _local_3:uint = uint(uint(16 - _arg_1.length % 16) || 16);
         do
         {
         ...
         while(_local_3 < _local_4)
         {
            ...
            while(_local_8 < 16)
            {
               _local_6 = uint(_local_5[_local_8] = _local_5[_local_8] ^ S[_arg_1[_local_3 + _local_8] ^ _local_6]);
               _local_8++;
            }
            _local_3 += 16;
         }
         ...
         while(_local_3 < _local_4)
         {
            ...
            while(_local_8 < 18)
            {
               ...
               while(_local_10 < 48)
               {
                  _local_7[_local_10] = _local_9 = uint(_local_7[_local_10] ^ S[_local_9]);
                  _local_10++;
               }
               _local_9 = uint(_local_9 + _local_8 & 0xFF);
               _local_8++;
            }
            _local_3 += 16;
         }
